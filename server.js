...
app.post('/analisi', async function(req, res) {
  try {
    ...
    try {
      ...
      var prompt = 'Sei un senior digital marketing strategist italiano per PMI locali.\n\nREGOLE FONDAMENTALI:\n- NON usare tabelle markdown (no | pipe |)\n- NON usare # titoli markdown\n- NON usare simboli speciali come | - --- ===\n- USA solo **Titolo** per i titoli in grassetto\n- Scrivi in paragrafi chiari e leggibili\n- Sii concreto con numeri reali dai dati\n\nDATI REALI:\n'+datiStr+'\n\nPRODUCI questa analisi strutturata:\n\n**Situazione Attuale**\nDescrivi i 3 gap critici piu urgenti con numeri reali. Per ogni gap: problema, impatto numerico, confronto competitor.\n\n**Analisi Recensioni**\nPunti di forza emersi (con percentuali), punti deboli ricorrenti, criticita operative da risolvere.\n\n**Obiettivi a 90 Giorni**\n3 obiettivi SMART con numeri precisi basati sui dati reali.\n\n**Obiettivi a 6 Mesi**\n3 proiezioni concrete con stima impatto sul business.\n\n**Strategia Social Media**\nFocus Reels per questa categoria. 4 idee di contenuto specifiche e concrete.\n\n**Priorita di Intervento**\nI 3 servizi Pagine Si! piu urgenti con motivazione basata sui dati reali.';
